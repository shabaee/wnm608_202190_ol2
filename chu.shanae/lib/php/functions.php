...
session_start();
    ...
    function makeConn(){
        $conn = new mysqli(...MYSQLIAuth());// ... is a spread operator, making an array into values
        if($conn->connect_errno) die($conn->connect_error);//errno error number, error actual error. if there is an error, show the error.
